...
/** Thresholds on the 0-100 raw score. */
const BANDS: BandDef[] = [
...
export interface ClusterMeta {
  ...
  typeName: string
  color: string
  /** Lighter tint of `color`, used for text/badges sitting on a near-black background (trading-card slab). */
  colorLight: string
