    ...
    >
      <div className="relative w-full max-w-xl rounded-2xl border border-white/10 bg-[#111] p-8 md:p-12">
        ...
        <p className="mt-5 text-center font-mono text-xs text-white/30">
          <a href="/profile" className="underline underline-offset-2 transition-colors hover:text-white/60">
            View your full mint history →
          </a>
        </p>
      </div>
    </div>
            ...
            <div className="w-[90%] space-y-8">
              ...
              <div>
                <div className="mb-3 flex items-center gap-3">
                  <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-ticket-red font-mono text-xs font-bold text-white">
                    1
                  </span>
                ...
                <p className="mt-1.5 font-sans text-xs text-white/30">
                  This is the wallet you&apos;ll use to claim your free NFT on OpenSea. Double-check it — it can&apos;t be changed after payment.
                </p>
              </div>
              ...
              <div>
                ...
                {!isValidWallet && (
                  ...
                  >
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-white/20">
