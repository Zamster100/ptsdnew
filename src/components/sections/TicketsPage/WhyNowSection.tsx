export const WhyNowSection = () => {
  return (
    <section className="section-blend px-[15px] py-12 font-sans text-white md:px-[60px] md:py-16">
      ...
      <h2 className="font-manrope mb-10 text-[36px] font-black leading-[1.0] md:text-[52px]">
        THE TOKEN IS COMING.
        <br />
        <span className="text-ticket-red">
          THE TICKET IS HOW YOU GET IN FIRST.
        </span>
      </h2>

      <div className="grid max-w-4xl grid-cols-1 gap-6 md:grid-cols-2 md:gap-12">
